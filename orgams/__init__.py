...
TIEMPO_CORTO = 60 # En segundos (Simulación, ListaEspera, FinRonda)
TIEMPO_LARGO = 150 # En segundos (Instrucciones, Donacion, Priorizacion)
...
class FinRonda(Page):
    ...
    @staticmethod
    def vars_for_template(p: Player):
        p.pago_final = p.payoff = (round((Pago_Final(p)*1)/5,1)+5)
